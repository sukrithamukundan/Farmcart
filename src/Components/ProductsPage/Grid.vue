        ...
        <div class="view-button">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="MenuLink">
              <a class="dropdown-item" @click="sortI('vegies')">Vegies</a>
              <a class="dropdown-item" @click="sortI('fruits')">Fruits</a>
              <a class="dropdown-item" @click="sortI('tools')">Tools</a>
              <a class="dropdown-item" @click="sortI('animals')">Animals</a>
              <a class="dropdown-item" @click="sortI('others')">Other</a>
              <div class="dropdown-divider"></div>
              <div class="pl-3">
                <span class="circle" style="background-color:yellow" @click="sortI('yellow')" />
                <span class="circle" style="background-color:green" @click="sortI('green')"  />
                ...
                <span class="circle" style="background-color:orange" @click="sortI('orange')" />
              </div>
              <div class="dropdown-divider"></div>
          ...
          <div class="card-selector">
            <div class="card-body p-5">
              <div class="search-title">
                <h4>Catagories  +</h4>
                <br>
                <h6 @click="sortI('vegies')">Vegies</h6>
                <h6 @click="sortI('fruits')">Fruits</h6>
                <h6 @click="sortI('tools')">Tools</h6>
                <h6 @click="sortI('animals')">Animals</h6>
                ...
                <div class="co">
                  ...
                  <span class="circle" style="background-color:green" @click="sortI('green')" ></span>
